...
function Autoplay(userOptions = {}) {
	...
	function init(emblaApiInstance, optionsHandler) {
		...
		if (options.stopOnMouseEnter) {
			...
			if (!options.stopOnInteraction) eventStore.add(root, "mouseleave", () => {
				resume = true;
				startTimer();
			});
		}
		if (options.stopOnFocusIn) {
			...
			if (!options.stopOnInteraction) eventStore.add(container, "focusout", startTimer);
		}
	...
	function next() {
		...
		if (options.stopOnLastSnap && nextIndex === lastIndex) stopTimer();
