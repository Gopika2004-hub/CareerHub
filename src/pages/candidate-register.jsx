  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await signUp.create({
        ...
        emailAddress,
        password,
        unsafeMetadata: { role: "candidate", mobile: mobileNumber },
      });
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      if (completeSignUp.status === "complete") {
        ...
        // Create initial profile so candidate appears in admin panel immediately
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-[#00529b] px-8 py-8 text-center">
            ...
            <p className="text-blue-100 text-sm mt-1">Join CareerHub to find your next role</p>
          </div>
          ...
          <div className="px-8 pb-8 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/candidate/login" className="font-semibold text-[#00529b] hover:underline">
                Sign In
              </Link>
            </p>
          </div>
