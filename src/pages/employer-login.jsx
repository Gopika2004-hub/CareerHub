      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-[#00529b] px-8 py-8 text-center">
            ...
            <p className="text-blue-100 text-sm mt-1">CareerHub Recruiter Portal</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  to="/forgot-password?portal=employer"
            ...
            <div className="flex items-center gap-2">
              <input
                id="remember-employer"
                type="checkbox"
                checked={rememberMe}
                onChange={(e) => setRememberMe(e.target.checked)}
                className="w-4 h-4 accent-[#00529b] cursor-pointer"
              />
              <label htmlFor="remember-employer" className="text-sm text-gray-600 cursor-pointer">
                Remember Me
              </label>
            </div>
          ...
          <div className="px-8 pb-8 text-center space-y-2">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/employer/register" className="font-semibold text-[#00529b] hover:underline">
                Register Now
              </Link>
            </p>
          </div>
        ...
        <p className="text-center text-slate-500 text-xs mt-3">
          Â© 2026 CareerHub â€” Employer Portal
        </p>
      </div>
    </div>
  );
